...
public class llegar_siete extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng siete = new LatLng(-0.208322, -78.491710);
        mMap.addMarker(new MarkerOptions().position(siete).title("Bienvenido al restaurante Siete Chiles"));

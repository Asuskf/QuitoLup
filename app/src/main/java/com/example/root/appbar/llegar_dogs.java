...
public class llegar_dogs extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(-0.207462, -78.493486);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Bienvenido a Rock your Dogs"));

...
public class llegar_anoranza extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng siete = new LatLng(-0.2249942546921247, -78.51364731802421);
        mMap.addMarker(new MarkerOptions().position(siete).title("Bienvenido al bar Añoranza"));

...
public class llegar_eva extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng siete = new LatLng(-0.202293, -78.492065);
        mMap.addMarker(new MarkerOptions().position(siete).title("Bienvenido a la Casa de Eva"));

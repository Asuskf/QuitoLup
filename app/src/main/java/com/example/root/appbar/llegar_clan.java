...
public class llegar_clan extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng siete = new LatLng(-0.205736, -78.488158);
        mMap.addMarker(new MarkerOptions().position(siete).title("Bienvenido a Burguer Clan"));

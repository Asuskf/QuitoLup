...
public class llegar_murcielago extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng siete = new LatLng(-0.223944, -78.514766);
        mMap.addMarker(new MarkerOptions().position(siete).title("Bienvenido a la casa del Murcielago"));
